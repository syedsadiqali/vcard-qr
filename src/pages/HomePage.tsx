      ...
      <section className="relative overflow-hidden rounded-2xl border border-border/70 bg-card/50 px-6 py-16 shadow-[0_0_45px_rgba(0,0,0,0.35)] backdrop-blur-lg sm:px-10 sm:py-24">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm text-muted-foreground sm:text-base">
            Turn your contact details into a clean, scannable QR code. Perfect
            for profile cards, conference booths, and product packaging. People
            can save your contact directly from the QR scan without visiting
            another website.
          </p>
          ...
          <div className="mt-4 grid gap-3 text-left sm:grid-cols-3">
            ...
            <div className="rounded-xl border border-border/70 bg-background/50 p-4">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                The preview updates instantly as you type, so you always know
                what gets encoded.
              </p>
            </div>
