...
export function Seo({ title, description, path, keywords, structuredData }: SeoProps) {
  useEffect(() => {
    ...
    upsertMeta('meta[name="keywords"]', "name", "keywords", keywords ?? "vCard QR, contact QR code, QR generator");

    upsertMeta('meta[property="og:type"]', "property", "og:type", "website");
    upsertMeta('meta[property="og:title"]', "property", "og:title", `${title} | ${siteTitle}`);
    upsertMeta('meta[property="og:description"]', "property", "og:description", description);
    upsertMeta('meta[property="og:url"]', "property", "og:url", canonicalUrl);

    upsertMeta('meta[name="twitter:card"]', "name", "twitter:card", "summary_large_image");
    upsertMeta('meta[name="twitter:title"]', "name", "twitter:title", `${title} | ${siteTitle}`);
